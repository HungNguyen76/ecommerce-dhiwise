...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Rebeca_Kunze77',
      password: 'D2WHF35cwjJMIGm',
      email: 'Jerrod18@hotmail.com',
      name: 'Nathan Miller',
      shippingAddress: [
        {
          _id: false,
      ...
      userType: 757,
      mobileNo: '(611) 433-8828',
      resetPasswordLink: {},
      loginRetryLimit: 780,
      loginReactiveTime: '2024-12-30T05:50:50.462Z',
      id: '659591e4b3aff9053d24186f'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Roy73',
        'password':'G5RbMvghYqO3RBm',
        'email':'Marion.Feeney49@hotmail.com',
        'name':'Jerald Hermann',
        'shippingAddress':[{
          '_id':false,
          'pincode':'Chair',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/device/auth/forgot-password')
      .send({ 'email':'Marion.Feeney49@hotmail.com', });
