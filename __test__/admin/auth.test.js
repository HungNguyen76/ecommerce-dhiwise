...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Orlo_Berge36',
      password: 'jUHZTcXvvnJF0Z4',
      email: 'Sharon_Abbott@yahoo.com',
      name: 'Clifford Hyatt',
      shippingAddress: [
        {
          _id: false,
      ...
      userType: 35,
      mobileNo: '(090) 256-4269',
      resetPasswordLink: {},
      loginRetryLimit: 50,
      loginReactiveTime: '2024-05-08T00:24:59.044Z',
      id: '659591e4b3aff9053d241803'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Verdie68',
        'password':'W7gtT5el5rjiXmw',
        'email':'Stefanie65@yahoo.com',
        'name':'Miss Kristen Aufderhar',
        'shippingAddress':[{
          '_id':false,
          'pincode':'XSS',
          'address1':'Pants',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Stefanie65@yahoo.com', });
